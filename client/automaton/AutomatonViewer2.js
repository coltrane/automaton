...
.directive('automatonViewer', function AutomatonViewerDirective(
    ...
    var tpl = ' \
      <div class="atmn-grid-scroll"></div> \
      <div class="atmn-grid-content"> \
        <div automaton-viewer-row ng-repeat="row in automatonViewer.rows track by automatonViewer.getRowUid(row)"></div> \
      </table>';
    ...
    function link ($scope, $element, $attrs, $controller) {
        ...
        var tbl = $element.find('.atmn-grid-content');
